...
const Browse = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl md:text-4xl font-bold text-text mb-2">Browse</h1>
        <p className="text-muted">Explore all albums and collections</p>
      </div>
      ...
      >
        {albums.map((album) => (
          ...
          >
            ...
            <h3 className="font-semibold text-text">{album.title}</h3>
